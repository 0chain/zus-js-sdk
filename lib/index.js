...
exports.decodeAuthTicket = exports.recoverWallet = exports.createWallet = exports.unlockStakePool = exports.lockStakePool = exports.lockWritePool = exports.getReadPoolInfo = exports.createReadPool = exports.getBlobbers = exports.getBlobberIds = exports.getAllocationBlobbers = exports.getLookupHash = exports.getPublicEncryptionKey = exports.isWalletID = exports.getUSDRate = exports.downloadBlocks = exports.getFileStats = exports.createDir = exports.getNextSegment = exports.stop = exports.play = exports.moveObject = exports.copyObject = exports.renameObject = exports.deleteObject = exports.hideLogs = exports.showLogs = exports.share = exports.listObjects = exports.executeSmartContract = exports.getFaucetToken = exports.download = exports.bulkUpload = exports.getUpdateAllocationMinLock = exports.getAllocationMinLock = exports.updateAllocation = exports.cancelAllocation = exports.freezeAllocation = exports.reloadAllocation = exports.getAllocationFromAuthTicket = exports.getAllocation = exports.createAllocationWithBlobbers = exports.createFreeAllocation = exports.createAllocation = exports.listAllocations = exports.setWallet = exports.getBalanceWasm = exports.sendTransaction = exports.getBalance = exports.init = void 0;
exports.updateBlobberSettings = exports.updateContainer = exports.searchContainers = exports.makeSCRestAPICall = exports.refreshJwtToken = exports.multiOperation = exports.multiDownload = exports.getMinersAndSharders = exports.cancelUpload = exports.multiUpload = exports.listSharedFiles = exports.getMintWZCNPayload = exports.mintZCN = exports.burnZCN = exports.initBridge = void 0;
const utils_1 = require("./utils");
const zcn_1 = require("./zcn");
...
const init = async (config) => {
    ...
    log("config", config);
    domain = (_c = (_b = (_a = config[1]) === null || _a === void 0 ? void 0 : _a.replace("https://", "")) === null || _b === void 0 ? void 0 : _b.replace("http://", "")) === null || _c === void 0 ? void 0 : _c.replace("/dns", "");
    const wasm = await (0, zcn_1.createWasm)();
    log("wasm", wasm);
    if (shouldShowLogs)
        await ((_d = wasm === null || wasm === void 0 ? void 0 : wasm.sdk) === null || _d === void 0 ? void 0 : _d.showLogs());
    log(...config);
    await ((_e = wasm === null || wasm === void 0 ? void 0 : wasm.sdk) === null || _e === void 0 ? void 0 : _e.init(...config));
    log("window.bls", window === null || window === void 0 ? void 0 : window.bls);
    bls = window === null || window === void 0 ? void 0 : window.bls;
    log("bls", bls);
    await bls.init(bls === null || bls === void 0 ? void 0 : bls.BN254);
    goWasm = wasm;
    window === null || window === void 0 ? void 0 : window.Buffer = buffer_1.Buffer;
...
const getBalance = async (clientId) => {
    return (0, utils_1.getBalanceUtil)(clientId, domain);
};
 ...
 */
const sendTransaction = async (ae, toClientId, val, note) => {
    log("sendTransaction from:", ae, "to:", toClientId, "value:", val, "note:", note);
    return (0, utils_1.submitTransaction)(ae, toClientId, val, note, TransactionType.SEND, domain);
};
 ...
 */
const getBalanceWasm = async (clientId) => {
    const balanceObj = await goWasm.sdk.getWalletBalance(clientId);
    return balanceObj;
};
exports.getBalanceWasm = getBalanceWasm;
/**
 ...
 */
const setWallet = async (clientID, privateKey, publicKey, mnemonic) => {
 ...
 */
const createAllocation = async (allocationConfig) => {
    log("allocationConfig", allocationConfig);
    return await goWasm.sdk.createAllocation(allocationConfig.datashards, allocationConfig.parityshards, allocationConfig.size, allocationConfig.minReadPrice, allocationConfig.maxReadPrice, allocationConfig.minWritePrice, allocationConfig.maxWritePrice, allocationConfig.lock, []);
};
 ...
 */
const createFreeAllocation = async (fundingMarker, wallet) => {
    var _a;
    log("fundingMarker ", fundingMarker);
    const { result: input, error: decodeError } = (0, utils_1.decodeTicket)(fundingMarker);
    if (decodeError) {
        log('Error decoding funding marker: ', decodeError);
        return { error: decodeError };
    }
    const { data: nonceData, error: nonceError } = await (0, utils_1.getNonce)(wallet === null || wallet === void 0 ? void 0 : wallet.id);
    if (typeof (nonceData === null || nonceData === void 0 ? void 0 : nonceData.nonce) !== 'number' || nonceError) {
        log('Error getting nonce: ', nonceError);
        return { error: 'Error getting nonce' };
    }
    return await ((_a = goWasm === null || goWasm === void 0 ? void 0 : goWasm.sdk) === null || _a === void 0 ? void 0 : _a.createfreeallocation(input.marker));
};
exports.createFreeAllocation = createFreeAllocation;
/**
 ...
 */
const createAllocationWithBlobbers = async (allocationConfig) => {
    log("createAllocationWithBlobbers allocationConfig", allocationConfig);
    const txn = await goWasm.sdk.createAllocation(allocationConfig.datashards, allocationConfig.parityshards, allocationConfig.size, allocationConfig.minReadPrice, allocationConfig.maxReadPrice, allocationConfig.minWritePrice, allocationConfig.maxWritePrice, allocationConfig.lock, allocationConfig.blobbers);
    return txn;
};
exports.createAllocationWithBlobbers = createAllocationWithBlobbers;
/**
 ...
 * @returns {Promise<object>} - A Promise that resolves to an object containing information about the allocation.
 */
const getAllocationFromAuthTicket = async (authTicket) => {
    log("getAllocationFromAuthTicket", authTicket);
    const allocation = await goWasm.sdk.getAllocationWith(authTicket);
    return allocation;
};
exports.getAllocationFromAuthTicket = getAllocationFromAuthTicket;
/**
 ...
 */
const freezeAllocation = async (allocationId) => {
    log("freezeAllocation");
    const hash = await goWasm.sdk.freezeAllocation(allocationId);
    return hash;
};
exports.freezeAllocation = freezeAllocation;
/**
...
exports.cancelAllocation = cancelAllocation;
/**
 ...
 */
const updateAllocation = async (allocationId, size, extend, lock, updateTerms, addBlobberId, removeBlobberId) => {
    ...
    const hash = await goWasm.sdk.updateAllocation(allocationId, size, extend, lock, updateTerms, addBlobberId, removeBlobberId);
    log("hash", hash);
    return hash;
};
 ...
 */
const getAllocationMinLock = async (dataShards, size, parityShards, calculatedMaxWritePrice) => {
    ...
    return await goWasm.sdk.getAllocationMinLock(dataShards, parityShards, size, calculatedMaxWritePrice);
};
exports.getAllocationMinLock = getAllocationMinLock;
/**
 ...
 */
const getUpdateAllocationMinLock = async (allocationID, size, extend, addBlobberId, removeBlobberId) => {
...
exports.getUpdateAllocationMinLock = getUpdateAllocationMinLock;
/**
 ...
 */
const bulkUpload = async (objects) => {
 ...
 */
const download = async (allocationID, remotePath, authTicket, lookupHash, downloadThumbnailOnly, numBlocks, callbackFuncName, isFinal = true) => {
    log("download allocationID", allocationID, "remotePath", remotePath);
    const file = await goWasm.sdk.download(allocationID, remotePath, authTicket, lookupHash, downloadThumbnailOnly, numBlocks, callbackFuncName, isFinal);
    return file;
};
 ...
 */
const executeSmartContract = async (address, methodName, input, value) => {
 ...
 */
const listObjects = async (allocationId, path, offset = 0, limit = 50) => {
    log("listObjects", allocationId, path);
    return await goWasm.sdk.listObjects(allocationId, path, offset, limit);
};
 ...
 */
const share = async (allocationId, filePath, clientId, encryptionPublicKey, expireAt, revoke, availableAfter) => {
    log("share allocationId", allocationId, "filePath", filePath);
    const authTicket = await goWasm.sdk.share(allocationId, filePath, clientId, encryptionPublicKey, expireAt, revoke, availableAfter);
 ...
 */
const deleteObject = async (allocationId, path) => {
    log("deleteObject");
 ...
 */
const renameObject = async (allocationId, path, newName) => {
    log("renameObject");
 ...
 */
const copyObject = async (allocationId, path, destination) => {
    log("copyObject");
 ...
 */
const moveObject = async (allocationId, path, destination) => {
    log("moveObject");
 ...
 */
const play = async (allocationId, remotePath, authTicket, lookupHash, isLive) => {
    log("play");
...
exports.getNextSegment = getNextSegment;
/**
 ...
 */
const createDir = async (allocationId, path) => {
    log("createDir", path);
 ...
 */
const getFileStats = async (allocationId, path) => {
 ...
 */
const downloadBlocks = async (allocationID, remotePath, authTicket, lookupHash, numBlocks, startBlockNumber, endBlockNumber, callbackFuncName) => {
    log("downloadBlocks allocationID", allocationID, "remotePath", remotePath);
    const output = await goWasm.sdk.downloadBlocks(allocationID, remotePath, authTicket, lookupHash, numBlocks, startBlockNumber, endBlockNumber, callbackFuncName);
    return output;
};
exports.downloadBlocks = downloadBlocks;
/**
 ...
 */
const isWalletID = async (clientID) => {
 ...
 */
const getAllocationBlobbers = async (referredBlobberURLs, dataShards, parityShards, size, minReadPrice, maxReadPrice, minWritePrice, maxWritePrice) => {
    log("getAllocationBlobbers", referredBlobberURLs);
    const blobberList = await goWasm.sdk.getAllocationBlobbers(referredBlobberURLs, dataShards, parityShards, size, minReadPrice, maxReadPrice, minWritePrice, maxWritePrice);
    return blobberList;
};
exports.getAllocationBlobbers = getAllocationBlobbers;
/**
 ...
 */
const lockStakePool = async (providerType, txnValue, fee, providerId) => {
...
exports.lockStakePool = lockStakePool;
/**
...
const truncateAddress = (addressString = "", start = 5, flag = true, end = -4) => {
    if (flag) {
        return `${addressString === null || addressString === void 0 ? void 0 : addressString.slice(0, start)}...${addressString === null || addressString === void 0 ? void 0 : addressString.slice(end)}`;
    }
    else {
        return `${addressString === null || addressString === void 0 ? void 0 : addressString.slice(0, start)}...`;
    }
};
/**
...
const createWalletKeys = async (userMnemonic) => {
    ...
    const publicKeySha = (0, js_sha3_1.sha3_256)(hexPublicKey);
    const keys = {
...
const createWallet = async () => {
    ...
    const wallet = {
        ...
        keys: Object.assign(Object.assign({}, keys), { publicEncryptionKey: pubEncKey }),
    };
    return wallet;
};
 ...
 */
const decodeAuthTicket = async (authTicket) => {
...
exports.decodeAuthTicket = decodeAuthTicket;
/**
 ...
 */
const initBridge = async (ethereumAddress, bridgeAddress, authorizersAddress, wzcnAddress, ethereumNodeURL, gasLimit, value, consensusThreshold) => {
    log("initBridge", ethereumAddress, bridgeAddress, authorizersAddress, wzcnAddress, ethereumNodeURL, gasLimit, value, consensusThreshold);
    await goWasm.sdk.initBridge(ethereumAddress, bridgeAddress, authorizersAddress, wzcnAddress, ethereumNodeURL, gasLimit, value, consensusThreshold);
};
 ...
 */
const burnZCN = async (amount) => {
    log("burnZCN", amount);
    const hash = await goWasm.sdk.burnZCN(amount);
    return hash;
};
exports.burnZCN = burnZCN;
/**
 ...
 */
const listSharedFiles = async (lookupHash, allocationId, walletId) => {
    var _a;
    const allocation = await (0, exports.getAllocation)(allocationId);
    const randomIndex = Math.floor(Math.random() * ((_a = allocation === null || allocation === void 0 ? void 0 : allocation.blobbers) === null || _a === void 0 ? void 0 : _a.length));
    const blobber = allocation === null || allocation === void 0 ? void 0 : allocation.blobbers[randomIndex];
    const url = blobber.url + utils_1.Endpoints.ALLOCATION_FILE_LIST + allocationId;
    return (0, utils_1.getReqBlobbers)(url, { path_hash: lookupHash }, walletId);
};
 ...
 */
const multiUpload = async (jsonBulkUploadOptions) => {
 ...
 */
const cancelUpload = async (allocId, remotePath) => {
 ...
 */
const getMinersAndSharders = async () => {
    return await (0, utils_1.getMinersAndShardersUtils)(domain);
};
exports.getMinersAndSharders = getMinersAndSharders;
/**
 ...
 */
const multiDownload = async (allocId, files, authTicket, callbackFuncName) => {
    return goWasm.sdk.multiDownload(allocId, files, authTicket, callbackFuncName);
};
exports.multiDownload = multiDownload;
/**
 ...
 * @returns {Promise<any>} - A Promise that resolves to the list of files downloaded files.
 */
const multiOperation = async (allocId, jsonMultiOperationOptions) => {
    return goWasm.sdk.multiOperation(allocId, jsonMultiOperationOptions);
};
exports.multiOperation = multiOperation;
/*  Common - functions   */
/**
 ...
 */
const refreshJwtToken = async (phoneNumber, jwtToken) => {
    return await goWasm.sdk.refreshJwtToken(phoneNumber, jwtToken);
};
 ...
 */
const makeSCRestAPICall = async (scType, endpoint, stringifiedParams) => {
    return await goWasm.sdk.makeSCRestAPICall(utils_1.smartContractType[scType], endpoint, JSON.stringify(stringifiedParams));
};
exports.makeSCRestAPICall = makeSCRestAPICall;
/** Chimney Utils **/
/**
 ...
 */
const searchContainers = async (props) => {
 ...
 */
const updateContainer = async (props) => {
 ...
 */
const updateBlobberSettings = async (props) => {
    return await goWasm.sdk.updateBlobberSettings(props);
};
exports.updateBlobberSettings = updateBlobberSettings;
